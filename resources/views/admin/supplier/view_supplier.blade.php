            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="Details">
                        ...
                        <p><span style="font-weight: 900;">Type: </span>{{$id->type}}</p>
                        <p><span style="font-weight: 900;">Shop Name: </span>{{$id->shop}}</p>
                        ...
                        <p><span style="font-weight: 900;">Bank Branch: </span>{{$id->branch_name}}</p>
